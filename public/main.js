...
const yesterdayCountryData = require("../src/data/country/history/covid19200506.json");
const yesterdayProvinceData = require("../src/data/province/history/covid19200506.json");
const yesterdayWorldData = require("../src/data/world/history/worldtotal200506.json");
const url = "https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_daily_reports/05-07-2020.csv";
...
const getAllData = async () => {
    ...
    await fetch(url).then(response => {
        ...
        await fs.writeFileSync("src/data/all/history/covid19200507.json", covid19DataArray); 
    })
    return covid19Data
}
...
const makeWorldTotalFile = async () => {
    ...
    fs.writeFileSync("src/data/world/history/worldtotal200507.json", stringyWorldCasesArray);
}
...
const makeCountryDataFile = async () => {
    ...
    fs.writeFileSync("src/data/country/history/covid19200507.json", stringyCountryCasesArray);
}
const makeProvinceDataFile = async () => {
    ...
    fs.writeFileSync("src/data/province/history/covid19200507.json", stringyProvinceCasesArray);
}
