...
const yesterdayCountryData = require("../src/data/country/history/covid19200330.json");
const yesterdayProvinceData = require("../src/data/province/history/covid19200330.json");
const yesterdayWorldData = require("../src/data/world/history/worldtotal200330.json");
...
const getAllData = async () => {
    ...
    await fetch(url).then(response => {
        ...
        await fs.writeFileSync("src/data/all/history/covid19200331.json", covid19DataArray); 
    })
    return covid19Data
}
...
const makeWorldTotalFile = async () => {
    ...
    fs.writeFileSync("src/data/world/history/worldtotal200331.json", stringyWorldCasesArray);
}
...
const makeCountryDataFile = async () => {
    ...
    fs.writeFileSync("src/data/country/history/covid19200331.json", stringyCountryCasesArray);
}
const makeProvinceDataFile = async () => {
    ...
    fs.writeFileSync("src/data/province/history/covid19200331.json", stringyProvinceCasesArray);
}
